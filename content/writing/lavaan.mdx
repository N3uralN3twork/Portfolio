...
This is the most literal allocation reduction in the set: the code no longer
needs a cluster-by-parameter matrix just to immediately collapse it. The
...
estimators, which means the public API remains unchanged. It changes the internal cost model: cache what the code already
